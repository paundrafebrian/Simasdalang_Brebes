        ...
        <div class="card-body">
            <form action="{{ route('admin.profile.admin_update', $user->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="date_birth" type="date" class="form-control @error('date_birth') is-invalid @enderror" name="date_birth" value="{{ old('date_birth', $user->date_birth) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="internship_start" type="date" class="form-control @error('internship_start') is-invalid @enderror" name="internship_start" value="{{ old('internship_start', $user->internship_start) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="internship_end" type="date" class="form-control @error('internship_end') is-invalid @enderror" name="internship_end" value="{{ old('internship_end', $user->internship_end) }}">
